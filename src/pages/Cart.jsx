      ...
      <section className="p-4 xl:py-10 xl:px-0">
        <div className="max-w-[1000px] mx-auto border border-[#D9D9D9] rounded-2xl p-4 xl:p-10">
          <div className="flex justify-between items-center mb-10">
            ...
            <h2 className="text-2xl font-bold">2 Items</h2>
          </div>
          ...
          <div className="h-[1px] bg-[#D9D9D9] flex-grow my-5"></div>
          <div className="flex flex-col gap-5">
            <div className="flex justify-between items-center">
              <div className="w-[400px] flex items-center gap-10">
                <div className="bg-[#D9D9d9] w-[200px] h-[200px] rounded-2xl"></div>
          ...
          <div className="flex flex-col gap-2 items-end justify-center">
            ...
            <Link
              to="/"
              className="bg-[#D9D9D9] py-2 px-10 rounded-full font-semibold"
            >
              Checkout
            </Link>
          </div>
